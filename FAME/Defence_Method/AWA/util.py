...
from tensorflow.keras.layers import Input, Conv1D, Activation, BatchNormalization, Lambda, Conv2DTranspose, LeakyReLU, Dropout, Flatten, Dense, ELU, MaxPooling1D, Reshape, Average, ReLU, Lambda
